...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationSentenceQuestion
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationUserQuestions
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType.FOUR_TO_UNDER_SEVEN
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType.ORIGINAL
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType.SECTION_250
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType.UPDATED
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.ADIMP
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.ADIMP_ORA
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.SEC250
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.SEC250_ORA
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.YOI
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceCalculationType.YOI_ORA
