...
import uk.gov.justice.digital.hmpps.educationemploymentapi.entity.CalculationRequestUserInput
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.ADDITIONAL_DAYS_AWARDED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.ADDITIONAL_DAYS_SERVED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.RECALL_REMAND
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.RECALL_TAGGED_BAIL
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.REMAND
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.RESTORATION_OF_ADDITIONAL_DAYS_AWARDED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.TAGGED_BAIL
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.AdjustmentType.UNLAWFULLY_AT_LARGE
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.CalculationStatus
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.ARD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.CRD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.DPRRD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.ESED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.ETD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.HDCED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.LED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.LTD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.MTD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.NPD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.PED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.PRRD
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.SED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.SLED
import uk.gov.justice.digital.hmpps.educationemploymentapi.enumerations.ReleaseDateType.TUSED
import uk.gov.justice.digital.hmpps.educationemploymentapi.exceptions.UnsupportedCalculationBreakdown
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.AbstractSentence
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.Adjustment
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.Adjustments
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculatedReleaseDates
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationBreakdown
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationFragments
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationSentenceUserInput
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.CalculationUserInputs
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.ConcurrentSentenceBreakdown
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.ConsecutiveSentence
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.ConsecutiveSentenceBreakdown
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.ConsecutiveSentencePart
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.DateBreakdown
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.Offence
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.Offender
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.ReleaseDateCalculationBreakdown
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.SentenceDiagram
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.SentenceDiagramRow
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.SentenceDiagramRowSection
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.UserInputType
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.BookingAdjustmentType
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.BookingAndSentenceAdjustments
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.OffenderKeyDates
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.OffenderOffence
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceAdjustmentType
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceAdjustments
...
import uk.gov.justice.digital.hmpps.educationemploymentapi.model.external.SentenceTerms
